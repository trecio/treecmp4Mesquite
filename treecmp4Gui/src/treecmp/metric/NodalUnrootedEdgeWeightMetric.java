 ...
 * @author Damian
 */
public class NodalUnrootedEdgeWeightMetric extends BaseMetric implements Metric {

     private String name = "NodalUnrootedEdgeWeigt";
     public NodalUnrootedEdgeWeightMetric () {
    ...
    public double getDistance(Tree t1, Tree t2) {
        ...
        return NodalUnrootedEdgeWeightMetric.getNodalDistance(t1, t2);
    }
}
