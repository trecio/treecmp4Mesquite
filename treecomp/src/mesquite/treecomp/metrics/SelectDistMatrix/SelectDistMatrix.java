...
package mesquite.treecomp.metrics.SelectDistMatrix;
...
public class SelectDistMatrix extends NumberFor2Trees {
	...
	public String getPackageName() {
		return "Select Distance Matrix Package";
	}
	...
	public String getAuthors() {
		return "Denise Edwards, Lehman College, City University of NY";
	}
