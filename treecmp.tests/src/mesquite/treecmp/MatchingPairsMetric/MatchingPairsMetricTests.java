...
public class MatchingPairsMetricTests extends MetricTest<MatchingPairsMetric> {

	@Override
	protected MatchingPairsMetric createMetric() {
		return new MatchingPairsMetric();
	}
	...
	public void AscaridoidDataSanityCheck() {
		...
		Assert.assertEquals(178., getMetricValue(t1, t2));
	}
